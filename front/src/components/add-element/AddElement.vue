<template>
	<colllect-modal :width="'980px'" @close="hideAddElementModal" :show="show" class="c-colllect-add-element--modal">
		<div class="c-colllect-add-element">
			...
			<div class="c-colllect-add-element--form-column">
				<div class="c-colllect-add-element--form-column-inner">
					<div class="c-colllect-add-element--title" id="c-colllect-modal--title">Add a link</div>

					<colllect-input v-model="url" placeholder="http://colllect.io" autocomplete="off" autofocus>URL Address</colllect-input>
					<colllect-input v-model="name" autocomplete="off">Name</colllect-input>
				</div>
				<div class="c-colllect-add-element--buttons">
					<colllect-button>Save link</colllect-button>
				</div>
			</div>
			<div class="c-colllect-add-element--tags-column">
				<svg viewBox="0 0 126 106" xmlns="http://www.w3.org/2000/svg" class="c-colllect-add-element--tags-column-background">
					<g fill="currentColor">
						<path d="M115.535 17.853V48.35c0 3.905-1.488 7.531-4.184 10.135l-43.237 43.051c-1.395 1.395-2.976 2.417-4.742 3.161-1.767.651-3.533 1.023-5.393 1.023a14.83 14.83 0 0 1-4.928-.837c-1.58-.558-3.162-1.395-4.463-2.603L15.3 73.177a14.429 14.429 0 0 1-3.626-4.928c-.837-1.766-1.21-3.812-1.21-5.765 0-1.674.28-3.347.838-4.928.65-1.58 1.487-3.161 2.696-4.463.28-.186.465-.465.651-.65L62.814 4.276C65.418 1.581 69.044.093 72.856.093h24.269c1.952 0 3.812.279 5.485.837 1.767.558 3.348 1.395 4.743 2.324 2.789 1.953 5.114 4.557 6.601 7.718 1.023 2.046 1.581 4.37 1.581 6.88zM58.537 92.797c.093-.093.279-.186.372-.28l43.423-43.236c.279-.28.372-.558.372-.93V17.76c0-.28-.093-.651-.186-1.023-.071-.283-.249-.565-.453-.889-.064-.102-.131-.208-.198-.32a7.095 7.095 0 0 0-2.604-2.046c-.65-.371-1.302-.464-1.953-.464H73.043c-.372 0-.65.092-.93.371L24.04 61.462l-.093.093c-.116.059-.16.154-.199.24a.443.443 0 0 1-.08.132c-.093.186-.093.28-.093.465 0 .186 0 .372.094.558 0 .186.093.372.278.465l33.288 29.103c.059.117.153.16.24.2.05.023.097.045.132.08.186.093.279.093.465.093s.279 0 .465-.094z"/>
				...
				<div class="c-colllect-add-element--tags-column-tag-list">
					<div class="c-colllect-add-element--tags-column-tag-item" v-for="tag in tags" :style="{'--tag-color': tag.color }">
						<svg viewBox="0 0 126 106" xmlns="http://www.w3.org/2000/svg">
							<path d="M115.535 17.853V48.35c0 3.905-1.488 7.531-4.184 10.135l-43.237 43.051c-1.395 1.395-2.976 2.417-4.742 3.161-1.767.651-3.533 1.023-5.393 1.023a14.83 14.83 0 0 1-4.928-.837c-1.58-.558-3.162-1.395-4.463-2.603L15.3 73.177a14.429 14.429 0 0 1-3.626-4.928c-.837-1.766-1.21-3.812-1.21-5.765 0-1.674.28-3.347.838-4.928.65-1.58 1.487-3.161 2.696-4.463.28-.186.465-.465.651-.65L62.814 4.276C65.418 1.581 69.044.093 72.856.093h24.269c1.952 0 3.812.279 5.485.837 1.767.558 3.348 1.395 4.743 2.324 2.789 1.953 5.114 4.557 6.601 7.718 1.023 2.046 1.581 4.37 1.581 6.88zM58.537 92.797c.093-.093.279-.186.372-.28l43.423-43.236c.279-.28.372-.558.372-.93V17.76c0-.28-.093-.651-.186-1.023-.071-.283-.249-.565-.453-.889-.064-.102-.131-.208-.198-.32a7.095 7.095 0 0 0-2.604-2.046c-.65-.371-1.302-.464-1.953-.464H73.043c-.372 0-.65.092-.93.371L24.04 61.462l-.093.093c-.116.059-.16.154-.199.24a.443.443 0 0 1-.08.132c-.093.186-.093.28-.093.465 0 .186 0 .372.094.558 0 .186.093.372.278.465l33.288 29.103c.059.117.153.16.24.2.05.023.097.045.132.08.186.093.279.093.465.093s.279 0 .465-.094z" fill="currentColor"/>
							<path d="M84.293 39.797a8.461 8.461 0 1 0 0-16.923 8.461 8.461 0 0 0 0 16.923z" fill="currentColor"/>
						</svg>
						{{ tag.name }}
						<button class="c-colllect-add-element--tags-column-tag-remove">&times;</button>
					</div>
				</div>
				<div class="c-colllect-add-element--tags-column-suggested" v-if="suggestedTags.length > 0">
					<div class="c-colllect-add-element--tags-column-label">Suggested tags</div>
					<div class="c-colllect-add-element--tags-column-tag-list">
						<button class="c-colllect-add-element--tags-column-tag-item" v-for="tag in suggestedTags" :style="{'--tag-color': tag.color }">
							{{ tag.name }}
						</button>
					</div>
				</div>
...
<script src="./addElement.ts" lang="ts"/>
<style src="./addElement.scss" lang="scss"/>
